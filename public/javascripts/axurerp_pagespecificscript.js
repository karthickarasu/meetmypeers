...
var PageName = 'Login';
var PageId = 'p11de86f279fd42b092847787404ecfb7'
...
document.body.insertAdjacentHTML("afterBegin", "<div id='pd0u21NoteContainer' style='position:absolute;left:0;top:0;width:3000;z-index:500'></div>");
document.getElementById('pd0u21NoteContainer').style.visibility = document.getElementById('pd0u21').style.visibility;
...
document.body.insertAdjacentHTML("afterBegin", "<DIV class='intcases' id='u20LinksClick'></DIV>")
...
u20LinksClick.insertAdjacentHTML("beforeEnd", "<div class='intcaselink' onmouseout='SuppressBubble(event)' onclick='Clickufa45044d74d14d96b02ef21bea999ce3()'>1) When member gives valid details</div>")
function Clickufa45044d74d14d96b02ef21bea999ce3()
{

	self.location.href="Home--Dashboard.html" + GetQuerystring();

	ToggleLinks(window.event, 'u20LinksClick');
}

u20LinksClick.insertAdjacentHTML("beforeEnd", "<div class='intcaselink' onmouseout='SuppressBubble(event)' onclick='Clicku93113ebb334a4117800641a67c84aa67()'>2) When the member gives invalid details</div>")
function Clicku93113ebb334a4117800641a67c84aa67()
{
...
u4based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> User logged in to our app.<BR><BR></div><div class='anncontent'><span class='annfieldname'>Status:</span> Approved<BR><BR></div><div class='anncontent'><span class='annfieldname'>Benefit:</span> Important<BR><BR></div>");
...
u5based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> User can register to our app...<BR><BR></div><div class='anncontent'><span class='annfieldname'>Status:</span> Approved<BR><BR></div><div class='anncontent'><span class='annfieldname'>Benefit:</span> Important<BR><BR></div>");
...
u16based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> This textfield is for<BR><BR></div>");
